...
export const knownProxySlots : Record<string, ProxyResolver> = {
    ...
    "360894a13ba1a3210667c828492db98dca3e2076cc3735a920a3ca505d382bbc": EIP1967ProxyResolver,

    // EPI-1967
    // Beacon slot is a fallback if implementation is not set.
    // bytes32(uint256(keccak256('eip1967.proxy.beacon')) - 1)).
    "a3f0ad74e5423aebfd80d3ef4346578335a9a72aeaee59ff6cb3582b35133d50": NotImplemented("eip1967.proxy.beacon"),
    ...
    "7050c9e0f4ca769c69bd3a8ef740bc37934f8e2c036e5a723fd8ee048ed3f8c3": ZeppelinOSProxyResolver,

    // ERC-1822: Universal Upgradeable Proxy Standard (UUPS)
    // bytes32(uint256(keccak256("PROXIABLE")))
    "c5f16f0fcc639fa48a6947836d9850f504798523bf8c9a3a87d5876cf622bcf7": PROXIABLEProxyResolver,
