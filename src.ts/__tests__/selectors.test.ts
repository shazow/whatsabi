...
import { withCache, online_test } from "./offline";
...
online_test('online: selectorsFromBytecode for Uniswap v2 Router', async () => {
...
online_test('online: selectorsFromBytecode for 0x00000000 method', async () => {
