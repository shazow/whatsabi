...
function disasm(bytecode) {
    ...
    while (code.hasMore()) {
        ...
        if (code.at(-1) === opcodes_1.opcodes.CODECOPY &&
            code.at(-2) === opcodes_1.opcodes.PUSH1 &&
            code.at(-3) === opcodes_1.opcodes.PUSH2) {
        ...
        if (pos === runtimeOffset &&
            currentFunction.opTags.has(opcodes_1.opcodes.RETURN) &&
            !currentFunction.opTags.has(opcodes_1.opcodes.CALLDATALOAD)) {
        ...
        if (code.at(-3) === opcodes_1.opcodes.ISZERO &&
            ...
            code.at(-5) !== opcodes_1.opcodes.CALLVALUE) {
